...
class AsciiDocBuilderTest {

    private AsciiDocBuilder asciiDocBuilder;
    ...
    void setUp() {
        ...
        asciiDocBuilder.setLogInformation(logInformation);
    }
    ...
    void testCreateTabeles() {
        ...
        List<List<String[]>> tables = asciiDocBuilder.createTabeles();
